...
<!-- Bootstrap-table-1.8.1 -->
<script src="plugins/bootstrap-table-1.8.1-dist/bootstrap-table.min.js"></script>
<script src="plugins/bootstrap-table-1.8.1-dist/bootstrap-table-zh-CN.min.js"></script>
